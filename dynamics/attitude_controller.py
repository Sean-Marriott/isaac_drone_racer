...
class AttitudeController:
    def __init__(self, num_envs, J: torch.Tensor, K_attitude, K_omega, device="cpu"):
        """
        Initializes the attitude controller

        Parameters:
        - num_envs: Number of enviroments
        - J: (3, 3): Tensor of intertia matrix (same for all drones)
        - K_attitude: (3, 3) Tensor of proportional gain for attitude error
        - K_omega: (3, 3) Tensor of proportional gain for angular veclocity error 
